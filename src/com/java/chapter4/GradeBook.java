...
//GradeBook class that solves the class average problem
 ...
 // determine the class average based on 10 grades entered by the user
  public void determineClassAverage() {
     ...
     // create Scanner object to obtain input from command window
      ...
      int gradeCounter; // number of the next grade to be entered
     ...
     // termination phase
      average = total / 10; // integer division produces integer result
