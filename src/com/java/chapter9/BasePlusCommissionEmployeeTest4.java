...
// Test class for BasePlusCommissionEmployee4.
...
public class BasePlusCommissionEmployeeTest4 {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("%s %.2f%n", "Gross sales are",
        ...
        employee.setBaseSalary(1000); // set new base salary
